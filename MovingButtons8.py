...
class treeData():
	...
	def __init__(self, tree):
		...
		#Load tree
		self.t = tree
		self.treeVis = TreeVisualizer(num_nodes=self.t.size()) #tree visualizer is initialized with correct node number
...
#TODO: fix size of what ever determines what nodes can be selected so all nodes always fit
