...
class TreeVisualizer(Widget):
	...
	def add_node(self, i, input_position):
		...
		self.node_widgets.append(new_node)
...
class Control(Widget):
	...
	def clear_selection(self):
		if there_is(self.selection_1):
			selection_1 = self.parent.visualizer.node_widgets[self.selection_1]
			selection_1.deselect()
		if there_is(self.selection_2):
			selection_2 = self.parent.visualizer.node_widgets[self.selection_2]
			selection_2.deselect()
